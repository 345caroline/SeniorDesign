...
def join_network(port):
    ...
    WriteMessage(0x0020, 0x0001000400f000e1, port)
    ...
    # I don't know why there isn't a parameter for end node so I just picked legacy router
    WriteMessage(0x0023, 0x02, port)
    ...
    # 0x0025 is the message type for the start scan message
    # The start scan message does not contain a payload
    WriteMessage(0x0025, port)
    # Should recieve several messages back from the node
